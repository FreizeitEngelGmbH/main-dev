...
import { 
  ...
  Ticket, // Freizeitpark
  Key, // Escape Room
  Target, // Paintball/Lasertag
  Gamepad, // Movie Park
  Circle, // Billard
  DraftingCompass, // Minigolf
  Music, // Kultur & Unterhaltung
  Palmtree, // Entspannung & Wellness
  Heart, // Gesellige Aktivitäten
  Sparkles, // Freizeitparks & Erlebnisse
  ChevronDown
} from "lucide-react";
    ...
    <div className="bg-white border-b border-gray-100">
      <div className="container mx-auto px-4">
        <div className="hidden md:flex items-center py-2 overflow-x-auto scrollbar-hide">
          {/* Loading state could be implemented here */}
          ...
          <div className="flex space-x-8">
              ...
              <DropdownMenu key={group.id}>
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center group">
                    ...
                    <span className="text-sm font-medium text-gray-700 group-hover:text-primary mr-1">
                      {group.name}
                    </span>
            ...
            >
              ...
              <ChevronDown className="h-3.5 w-3.5 text-primary ml-1 rotate-[-90deg]" />
            </Link>
          </div>
        </div>
      </div>
