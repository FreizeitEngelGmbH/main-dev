import bowlingImg from "@assets/images/bowling.png"; // STATIC: substituted for missing real stock photo
import minigolfImg from "@assets/images/minigolf.png"; // STATIC: substituted for missing real stock photo
import kinoImg from "@assets/images/kino.png"; // STATIC: substituted for missing real stock photo
...
/**
 * All static data for the mocked backend. Field names and shapes match the
...
export const partnerBookings = Array.from({ length: 14 }).map((_, i) => {
...
// Seed data for this static build partner's own "Mach-mit-Gruppen" listings
...
// when the static build's create-group dialog "creates" a new group.
export const partnerGroupActivitiesSeed = [
  {
    id: 1,
    partnerId: null,
    experienceId: null,
...
export const partnerInquiriesSeed = [
  {
    id: 8501,
    partnerId: 501,
    experienceId: 3,
...
export const partnerInquiryTemplatesSeed = [
  {
    id: 7201,
    partnerId: 501,
...
export const categoryList = categoryNames.map((name, i) => ({
  id: i + 1,
  name,
  slug: name
    .toLowerCase()
...
export const partnerCommissionInvoices = [
  {
    id: 1,
 ...
 * sections. None of those exist in this static build's mocked getQueryFn, so those
...
// row - the real app models them as separate tables, but a 1:1 static
...
export const marketplacePartners = offerCatalog.map((o) => ({
  id: o.id,
...
export const featuredExperiences = offerCatalog.map((o, i) => ({
  id: o.id,
  title: o.title,
  description: o.description,
...
export const partnerSettlements = [
  {
    id: "2026-08",
    month: "August 2026",
    bookings: partnerBookings.slice(0, 6).map((b) => ({
      id: b.id,
  ...
  },
  {
    ...
    bookings: partnerBookings.slice(6, 10).map((b) => ({
      id: b.id,
      experienceTitle: b.experienceTitle,
      customerName: b.customerName,
      date: b.bookingDate,
 ...
 * as opposed to partnerProfile/partnerExperiences above which back the
 * partner's own private dashboard. Id 501 is the same sample partner as
 * partnerProfile so "Shop ansehen" shows a consistent storefront;
 ...
 */
const climbingImg =
  "https://images.unsplash.com/photo-1522163182402-834f871fd851?w=1200&h=800&fit=crop"; // STATIC: substituted for missing real stock photo
const escapeRoomImg =
  "https://images.unsplash.com/photo-1587825140708-dfaf18c4f8e0?w=1200&h=800&fit=crop"; // STATIC: substituted for missing real stock photo

export const shopPartners = [
  {
    id: 501,
    companyName: "Kletterhalle Vertical Dortmund",
    city: "Dortmund",
